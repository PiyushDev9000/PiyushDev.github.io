...
const greetTextCont = document.querySelector(".greetTextCont")
const greetImgCont = document.querySelector(".greetImgCont")
const authorName = document.querySelector(".name")
const jobTitleContainers = document.querySelectorAll(".jobTitleCont")
...
window.addEventListener("scroll", ()=>{
    ...
    greetTextCont.style.transform= `translateY(${offsetY * 0.1}px)`
    greetImgCont.style.transform= `translate(${offsetY * 0.4}px, ${offsetY * 0.7}px)`
